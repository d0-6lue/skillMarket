...
// 링크
function linkNotice(){location.href= root_admin+'/notice';}
function linkFAQ(){location.href= root_admin+'/FAQ';}
function linkMembers(){location.href= root_admin+'/members';}
function linkReport(){location.href= root_admin+'/report';}
function linkInquiry(){location.href= root_admin+'/inquiry';}