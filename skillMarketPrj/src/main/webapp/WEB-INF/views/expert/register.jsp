            ...
            <div class="register-area">
                ...
                <div class="register-body">
                    ...
                    <div class="register-content">
                        ...
                        <div>닉네임은 1회만 수정 가능합니다</div>
                        <div>닉네임 변경 이력이 있다면 수정하기 기능이 비활성화 됩니다</div>
                        <div>자기소개</div>
                        <textarea name="expertIntroduction" placeholder="자기소개"></textarea>
                        <div>주소</div>
                        <input type="text" name="expertAddress" placeholder="주소">
                        <div>연락가능시간</div>
                        <input type="text" name="expertTime" placeholder="연락가능시간">
                        <div>전문분야</div>
                        <select name="">
