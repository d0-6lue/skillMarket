...
<body>
    ...
    <main>
        ...
        <form action="${root}/my-info/change-pwd" method="post">
            <div class="changepwd-area">
                ...
                <div class="changepwd-body">
                        ...
                        <input type="password" name="memberPwd" placeholder="기존 비밀번호를 입력해주세요">
                        ...
                        <div class="expertinfo-submit-btn">
                            <input class="bold" type="submit" value="비밀번호 변경">
                        </div>
                </div>
