...
<body>
    ...
    <main>
        <form action="/skillmarket/forgot-pwd" method="post">
            <div class="find-body">
                ...
                <div>
                    ...
                    <div>아이디와 이메일 주소를 입력해주시면 해당 이메일로 아이디를 보내줍니다.</div>
                    <div class="findid-email-title bold">아이디</div>
                    <input type="email" name="findId" class="findid-email" placeholder="아이디를 입력해주세요">
