...
<body>
    ...
    <main>
            <div class="find-body">
                <div class="find-title bold">아이디 확인</div>
                
                <div class="find-content">해당 아이디는</div>
                <div class="find-content2">${memberId}입니다</div>
                <div class="btn-area">
                    <button class="btn-detail bold" onclick="location.href='${root}/home'">홈으로 가기</button>
                    <button class="btn-detail2 bold" onclick="location.href='${root}/forgot-pwd'">비밀번호 찾기</button>
