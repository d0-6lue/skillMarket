...
VALUES ( 701, 601, 10201, '저렴한 가격에 퀄리티 높은 반응형 홈페이지 제작해드립니다.', 'project701Thumbnail.jpg', '최적의 홈페이지를 만들기 위해 스스로 기획하고 작업하며 고객님의 만족하는 모습을 목표로 하는 전문가들', 770000, 12, '서비스 설명 : 최적의 홈페이지를 만들기 위해 .. 추구하는 홈페이지는 .. 포트폴리오 .. 유지보수 내역 ..', '상세내용 파일(?)'
